...
import { ActionsRegistry } from '@modules/actions/actions-registry';
import { ReactionsRegistry } from '@modules/reactions/reactions-registry';
...
export class EngineService {
    ...
    private async processArea(area: any) {
        ...
        const reactionHandler = this.moduleRef.get(ReactionHandlerClass, { strict: false });
